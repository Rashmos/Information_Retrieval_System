...
/*     */   {
/*  79 */     return ((value >> 0 & 0xFF) << 56) + ((value >> 8 & 0xFF) << 48) + ((value >> 16 & 0xFF) << 40) + ((value >> 24 & 0xFF) << 32) + ((value >> 32 & 0xFF) << 24) + ((value >> 40 & 0xFF) << 16) + ((value >> 48 & 0xFF) << 8) + ((value >> 56 & 0xFF) << 0);
/*     */   }
/*     */ 
...
/*     */ 
/* 190 */     return (high << 24) + (0xFFFFFFFF & low);
/*     */   }
/*     */ 
/*     */   public static void writeSwappedLong(byte[] data, int offset, long value)
/*     */   {
/* 201 */     data[(offset + 0)] = ((byte)(int)(value >> 0 & 0xFF));
/* 202 */     data[(offset + 1)] = ((byte)(int)(value >> 8 & 0xFF));
/* 203 */     data[(offset + 2)] = ((byte)(int)(value >> 16 & 0xFF));
/* 204 */     data[(offset + 3)] = ((byte)(int)(value >> 24 & 0xFF));
/* 205 */     data[(offset + 4)] = ((byte)(int)(value >> 32 & 0xFF));
/* 206 */     data[(offset + 5)] = ((byte)(int)(value >> 40 & 0xFF));
/* 207 */     data[(offset + 6)] = ((byte)(int)(value >> 48 & 0xFF));
/* 208 */     data[(offset + 7)] = ((byte)(int)(value >> 56 & 0xFF));
/*     */   }
/*     */ 
...
/*     */ 
/* 229 */     return (high << 32) + (0xFFFFFFFF & low);
/*     */   }
/*     */ 
...
/*     */ 
/* 379 */     return (high << 24) + (0xFFFFFFFF & low);
/*     */   }
/*     */ 
/*     */   public static void writeSwappedLong(OutputStream output, long value)
/*     */     throws IOException
/*     */   {
/* 392 */     output.write((byte)(int)(value >> 0 & 0xFF));
/* 393 */     output.write((byte)(int)(value >> 8 & 0xFF));
/* 394 */     output.write((byte)(int)(value >> 16 & 0xFF));
/* 395 */     output.write((byte)(int)(value >> 24 & 0xFF));
/* 396 */     output.write((byte)(int)(value >> 32 & 0xFF));
/* 397 */     output.write((byte)(int)(value >> 40 & 0xFF));
/* 398 */     output.write((byte)(int)(value >> 48 & 0xFF));
/* 399 */     output.write((byte)(int)(value >> 56 & 0xFF));
/*     */   }
/*     */ 
