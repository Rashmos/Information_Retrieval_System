...
/*  77 */       throw new ArrayIndexOutOfBoundsException(new StringBuilder().append("illegal index: ").append(index).append(" into array of length ").append(data.length).toString());
/*     */     }
/*     */ 
/*  81 */     if (stream == null) {
...
/* 103 */         if ((data[(k + j)] >= 32) && (data[(k + j)] < 127))
