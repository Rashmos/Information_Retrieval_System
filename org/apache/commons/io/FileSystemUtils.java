...
/* 102 */   private static final int OS = os;
/* 103 */   private static final String DF = dfPath;
/*     */ 
/*     */   @Deprecated
...
/* 290 */       path = new StringBuilder().append("\"").append(path).append("\"").toString();
/*     */     }
/*     */ 
/* 294 */     String[] cmdAttribs = { "cmd.exe", "/C", new StringBuilder().append("dir /a /-c ").append(path).toString() };
/*     */ 
/* 297 */     List lines = performCommand(cmdAttribs, 2147483647, timeout);
/*     */ 
/* 303 */     for (int i = lines.size() - 1; i >= 0; i--) {
/* 304 */       String line = (String)lines.get(i);
/* 305 */       if (line.length() > 0) {
/* 306 */         return parseDir(line, path);
/*     */       }
/*     */     }
/*     */ 
/* 310 */     throw new IOException(new StringBuilder().append("Command line 'dir /-c' did not return any info for path '").append(path).append("'").toString());
/*     */   }
/*     */ 
...
/*     */     }
/* 351 */     if (j < 0) {
/* 352 */       throw new IOException(new StringBuilder().append("Command line 'dir /-c' did not return valid info for path '").append(path).append("'").toString());
/*     */     }
/*     */ 
...
/* 385 */     String flags = "-";
/* 386 */     if (kb) {
/* 387 */       flags = new StringBuilder().append(flags).append("k").toString();
/*     */     }
/* 389 */     if (posix) {
/* 390 */       flags = new StringBuilder().append(flags).append("P").toString();
/*     */     }
/* 392 */     String[] cmdAttribs = { DF, flags.length() > 1 ? new String[] { DF, flags, path } : path };
/*     */ 
/* 396 */     List lines = performCommand(cmdAttribs, 3, timeout);
/* 397 */     if (lines.size() < 2)
/*     */     {
/* 399 */       throw new IOException(new StringBuilder().append("Command line '").append(DF).append("' did not return info as expected ").append("for path '").append(path).append("'- response was ").append(lines).toString());
/*     */     }
/*     */ 
/* 403 */     String line2 = (String)lines.get(1);
/*     */ 
/* 406 */     StringTokenizer tok = new StringTokenizer(line2, " ");
/* 407 */     if (tok.countTokens() < 4)
/*     */     {
/* 409 */       if ((tok.countTokens() == 1) && (lines.size() >= 3)) {
/* 410 */         String line3 = (String)lines.get(2);
/* 411 */         tok = new StringTokenizer(line3, " ");
/*     */       } else {
/* 413 */         throw new IOException(new StringBuilder().append("Command line '").append(DF).append("' did not return data as expected ").append("for path '").append(path).append("'- check path is valid").toString());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 438 */       if (bytes < 0L) {
/* 439 */         throw new IOException(new StringBuilder().append("Command line '").append(DF).append("' did not find free space in response ").append("for path '").append(path).append("'- check path is valid").toString());
/*     */       }
/*     */ 
/* 443 */       return bytes;
/*     */     }
/*     */     catch (NumberFormatException ex) {
/* 446 */       throw new IOExceptionWithCause(new StringBuilder().append("Command line '").append(DF).append("' did not return numeric data as expected ").append("for path '").append(path).append("'- check path is valid").toString(), ex);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 472 */     List lines = new ArrayList(20);
...
/*     */       {
/* 500 */         throw new IOException(new StringBuilder().append("Command line returned OS error code '").append(proc.exitValue()).append("' for command ").append(Arrays.asList(cmdAttribs)).toString());
/*     */       }
/*     */ 
/* 504 */       if (lines.isEmpty())
/*     */       {
/* 506 */         throw new IOException(new StringBuilder().append("Command line did not return any info for command ").append(Arrays.asList(cmdAttribs)).toString());
/*     */       }
/*     */ 
/* 510 */       return lines;
/*     */     }
/*     */     catch (InterruptedException ex) {
/* 513 */       throw new IOExceptionWithCause(new StringBuilder().append("Command line threw an InterruptedException for command ").append(Arrays.asList(cmdAttribs)).append(" timeout=").append(timeout).toString(), ex);
/*     */     }
/*     */     finally
/*     */     {
