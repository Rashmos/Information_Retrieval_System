...
/*  389 */       if ((array[i] == separator) && (array[(i - 1)] == '.') && ((i == prefix + 1) || (array[(i - 2)] == separator)))
/*      */       {
/*  391 */         if (i == size - 1) {
...
/*      */     }
/*      */ 
/*  402 */     label464: for (int i = prefix + 2; i < size; i++) {
/*  403 */       if ((array[i] == separator) && (array[(i - 1)] == '.') && (array[(i - 2)] == '.') && ((i == prefix + 2) || (array[(i - 3)] == separator)))
/*      */       {
/*  405 */         if (i == prefix + 2) {
/*  406 */           return null;
/*      */         }
...
/*  498 */       return normalize(new StringBuilder().append(basePath).append(fullFilenameToAdd).toString());
/*      */     }
/*  500 */     return normalize(new StringBuilder().append(basePath).append('/').append(fullFilenameToAdd).toString());
/*      */   }
/*      */ 
...
/*      */   {
/*  554 */     if ((path == null) || (path.indexOf(92) == -1)) {
/*  555 */       return path;
/*      */     }
...
/*      */   {
/*  567 */     if ((path == null) || (path.indexOf(47) == -1)) {
/*  568 */       return path;
/*      */     }
...
/*      */     }
/*  640 */     if (ch0 == '~') {
/*  641 */       int posUnix = filename.indexOf(47, 1);
/*  642 */       int posWin = filename.indexOf(92, 1);
...
/*  662 */       int posUnix = filename.indexOf(47, 2);
/*  663 */       int posWin = filename.indexOf(92, 2);
...
/*  712 */       return -1;
/*      */     }
/*  714 */     int extensionPos = filename.lastIndexOf(46);
...
/*  758 */       return new StringBuilder().append(filename).append('/').toString();
/*      */     }
...
/* 1289 */     int textIdx = 0;
/* 1290 */     int wcsIdx = 0;
/* 1291 */     Stack backtrack = new Stack();
/*      */     do
/*      */     {
/* 1295 */       if (backtrack.size() > 0) {
/* 1296 */         int[] array = (int[])backtrack.pop();
/* 1297 */         wcsIdx = array[0];
...
/*      */   {
/* 1371 */     if ((text.indexOf(63) == -1) && (text.indexOf(42) == -1)) {
/* 1372 */       return new String[] { text };
/*      */     }
/*      */ 
/* 1375 */     char[] array = text.toCharArray();
/* 1376 */     ArrayList list = new ArrayList();
...
/*      */     }
/*      */ 
/* 1398 */     return (String[])list.toArray(new String[list.size()]);
/*      */   }
/*      */ 
/*      */   static
/*      */   {
