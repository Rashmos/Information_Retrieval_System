...
/*     */     }
/*  83 */     List acceptedFiles = new ArrayList();
...
/*     */       }
/*     */     }
/*  92 */     return (File[])acceptedFiles.toArray(new File[acceptedFiles.size()]);
/*     */   }
/*     */ 
/*     */   public static File[] filter(IOFileFilter filter, Iterable<File> files)
/*     */   {
/* 122 */     List acceptedFiles = filterList(filter, files);
/* 123 */     return (File[])acceptedFiles.toArray(new File[acceptedFiles.size()]);
/*     */   }
/*     */ 
/*     */   public static List<File> filterList(IOFileFilter filter, Iterable<File> files)
/*     */   {
/* 152 */     return (List)filter(filter, files, new ArrayList());
/*     */   }
/*     */ 
...
/*     */   {
/* 243 */     return (Set)filter(filter, files, new HashSet());
/*     */   }
/*     */ 
...
/*     */     }
/* 452 */     List list = new ArrayList(filters.length);
