...
/* 129 */     result = new SnowballFilter(result, new FinnishStemmer());
...
/*     */       try
/*     */       {
/*  66 */         DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader(SnowballFilter.class, "finnish_stop.txt", IOUtils.CHARSET_UTF_8), Version.LUCENE_CURRENT);
/*     */       }
 ...
 * Qualified Name:     org.apache.lucene.analysis.fi.FinnishAnalyzer
