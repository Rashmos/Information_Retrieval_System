...
/*    */   {
/* 36 */     super(input);
/* 37 */     this.termAtt = ((TermAttribute)addAttribute(TermAttribute.class));
/*    */   }
/*    */ 
...
/* 47 */       char[] buffer = this.termAtt.termBuffer();
/* 48 */       int length = this.termAtt.termLength();
/*    */ 
/* 51 */       for (int i = 0; i < length; i++) {
/* 52 */         char c = buffer[i];
/* 53 */         if ((c >= 'À') && (c <= 64262)) {
/* 54 */           removeAccents(buffer, length);
/* 55 */           this.termAtt.setTermBuffer(this.output, 0, this.outputPos);
/* 56 */           break;
/*    */         }
/*    */       }
/* 59 */       return true;
