...
/* 120 */       this.fcsi = fcsi;
/* 121 */       this.openBitSet = new OpenBitSet(this.fcsi.lookup.length);
...
/* 124 */         if (termNumber > 0)
/* 125 */           this.openBitSet.fastSet(termNumber);
/*     */       }
/*     */     }
/*     */ 
...
/*     */         try
/*     */         {
/* 152 */           while (!FieldCacheTermsFilter.FieldCacheTermsFilterDocIdSet.this.openBitSet.fastGet(FieldCacheTermsFilter.FieldCacheTermsFilterDocIdSet.this.fcsi.order[(++this.doc)]));
/*     */         }
...
/*     */         try {
/* 162 */           this.doc = target;
/* 163 */           while (!FieldCacheTermsFilter.FieldCacheTermsFilterDocIdSet.this.openBitSet.fastGet(FieldCacheTermsFilter.FieldCacheTermsFilterDocIdSet.this.fcsi.order[this.doc]))
/* 164 */             this.doc += 1;
/*     */         }
/*     */         catch (ArrayIndexOutOfBoundsException e) {
