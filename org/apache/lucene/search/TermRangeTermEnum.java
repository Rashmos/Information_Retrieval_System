...
/* 138 */       if (((this.lowerTermText == null) || (this.includeLower ? this.collator.compare(term.text(), this.lowerTermText) >= 0 : this.collator.compare(term.text(), this.lowerTermText) > 0)) && ((this.upperTermText == null) || (this.includeUpper ? this.collator.compare(term.text(), this.upperTermText) <= 0 : this.collator.compare(term.text(), this.upperTermText) < 0)))
/*     */       {
/* 146 */         return true;
/*     */       }
/* 148 */       return false;
