...
/*     */ 
/* 514 */     protected final void setEstimatedSize(String size) { this.size = size; }
/*     */ 
/*     */ 
/*     */     public void estimateSize()
/*     */     {
/* 520 */       estimateSize(new RamUsageEstimator(false));
/*     */     }
/*     */ 
/*     */     public void estimateSize(RamUsageEstimator ramCalc)
/*     */     {
/* 527 */       long size = ramCalc.estimateRamUsage(getValue());
/* 528 */       setEstimatedSize(RamUsageEstimator.humanReadableUnits(size, new DecimalFormat("0.#")));
/*     */     }
/*     */ 
