...
/*     */     throws IOException
/*     */   {
/* 193 */     Arrays.sort(this.subSpansByDoc, this.spanDocComparator);
...
/*     */     {
/* 211 */       assert (this.subSpansByDoc[i].doc() == maxDoc) : (" NearSpansOrdered.toSameDoc() spans " + this.subSpansByDoc[0] + "\n at doc " + this.subSpansByDoc[i].doc() + ", but should be at " + maxDoc);
/*     */     }
